...
export class LocalizationService {
    ...
    dictionary = {
        ...
        studentManual: { gr: 'Το συμβόλαιό μας', en: 'Student Manual' },
        studentManualOnline: { gr: 'Το συμβόλαιό μας για διαδικτυακούς μαθητές/μαθήτριες', en: 'Student Manual for Online Students' },
        acceptStudentManualText: { gr: 'Αποδέχομαι το "Συμβόλαιό μας"', en: 'I accept the "Student Contract"' },
        ...
        fundingSource: { gr: 'Κάλυψη Εξόδων', en: 'Expense Coverage' },
        fundingSelf: { gr: 'Δικοί μου Πόροι', en: 'Own Resources' },
        fundingThirdParty: { gr: 'Τρίτος', en: 'Third Party' },
        fundingPartial: { gr: 'Μερική Κάλυψη', en: 'Partial' },
