...
export class LocalizationService {
    ...
    dictionary = {
        ...
        date: { gr: 'Ημερομηνία', en: 'Date (dd-mm-yyyy)' },
        ...
        levelNativeSpeaker: { gr: 'Μητρική Γλώσσα', en: 'Native Speaker' },
        ...
        education: { gr: 'Εκπαίδευση', en: 'Education' },
        ...
        emergencyContact: { gr: 'Επαφή Έκτακτης Ανάγκης', en: 'Emergency Contact' },
        ...
        recommendationLetters: { gr: 'Συστατικές Επιστολές', en: 'Letters of Recommendation' },
        recommendationLetter1: { gr: 'Συστατική Επιστολή 1: Ποιμένας ή Πρεσβύτερος', en: 'Recommendation Letter 1: Pastor or Elder' },
        recommendationLetter2: { gr: 'Συστατική Επιστολή 2: Καθηγητής, Υπεύθυνος Διακονίας ή Εργοδότης', en: 'Recommendation Letter 2: Professor, Ministry Coordinator, or Employer' },
        recommendationLetter3: { gr: 'Συστατική Επιστολή 3: Τρίτο Πρόσωπο', en: 'Recommendation Letter 3: Third Reference' },
        referencesFamilyWarning: {
            gr: 'Σημείωση: Τα παρακάτω πρόσωπα δεν μπορούν να ανήκουν στο άμεσο οικογενειακό σας περιβάλλον.',
            en: 'Notice: The individuals below cannot be members of your immediate family.'
        },
        modeOfStudy: { gr: 'Πρόγραμμα / Μάθημα(τα)', en: 'Program / Course(s)' },
        ...
        ifAvailable: { gr: 'Εφόσον είναι διαθέσιμο', en: 'If available' },
        ...
        whichProgramAreYouInterestedIn: { gr: 'Για ποιο πρόγραμμα / μάθημα(τα) ενδιαφέρεστε;', en: 'Which program / course(s)are you interested in?' },
        greekProgram: { gr: 'Ελληνικό Πρόγραμμα', en: 'Greek Program' },
        ispProgram: { gr: 'Διεθνές Πρόγραμμα Σπουδών (ISP)', en: 'International Student Program (ISP)' },
        otherProgram: { gr: 'Άλλο', en: 'Other' },
        whichClassAreYouInterestedIn: { gr: 'Για ποιο πρόγραμμα ή μάθημα(τα) ενδιαφέρεστε;', en: 'Which program or specific course(s) are you interested in?' },
        ...
        greekSsn: { gr: '9-ψήφιος Αριθμός Φορολογικού Μητρώου (Α.Φ.Μ.)', en: '9-Digit Tax Identification Number (A.F.M. - preferred) or SSN' },
        ...
        foreignLanguageCertifications: { gr: 'Πιστοποιητικό/ά Ξένης Γλώσσας', en: 'Foreign Language Certification(s)' },
        uploadForeignLanguageCertifications: { gr: 'Μεταφόρτωση Πιστοποιητικών Γλωσσομάθειας', en: 'Upload Language Certifications' },
        ...
        churchName: { gr: 'Όνομα Εκκλησίας που εκκλησιάζεστε', en: 'Name of Church you attend' },
        ...
        payProcessingFee: { gr: 'Για την επεξεργασία της παρούσας αίτησης θα καταβάλετε το ακόλουθο Παράβολο Επεξεργασίας Αίτησης Εγγραφής', en: 'For processing this application, you will pay the following Application Processing Fee' },
        depositCard: { gr: '30€ (με κάρτα)', en: '30€ (by card)' },
        depositWire: { gr: '30€ (με κατάθεση)', en: '30€ (by bank deposit)' },
        ...
        piraeusBank: { gr: 'Τράπεζα Πειραιώς', en: 'Piraeus Bank' },
        ...
        financialApproval: { gr: 'Είμαι ενήμερος -η ότι υπάρχει κόστος φοίτησης (και διαμονής) και προτίθεμαι να φροντίσω να καλυφθεί πλήρως', en: 'I know that there is a cost for tuition (and for Room & Board if applicable), and I plan to make sure it will be paid in full' },
        ...
        communicableDiseases: { gr: 'Μεταδοτικές Ασθένειες', en: 'Communicable Diseases' },
        hasContagiousDiseaseQuestion: { gr: 'Υπάρχει κάποια μεταδοτική ασθένεια η οποία θα επηρεάσει τη συγκατοίκησή σου (π.χ. ηπατίτιδα);', en: 'Is there any contagious disease that will affect your cohabitation (e.g. hepatitis)?' },
        medicalTreatmentQuestion: { gr: 'Παίρνεις κάποια φαρμακευτική αγωγή ή είσαι κάτω από ιατρική παρακολούθηση;', en: 'Are you currently receiving any kind of medical treatment/medication?' },
        foodAllergiesQuestion: { gr: 'Έχεις κάποια αλλεργία ή τροφές που απαγορεύεται να τρως;', en: 'Are there any food allergies or foods you must avoid?' },
        studentManual: { gr: 'Το συμβόλαιό μας', en: 'Student Handbook' },
        studentManualOnline: { gr: 'Το συμβόλαιό μας για διαδικτυακούς μαθητές/μαθήτριες', en: 'Student Handbook for Online Students' },
        acceptStudentManualText: { gr: 'Αποδέχομαι το "Συμβόλαιό μας"', en: 'I accept the "Student Handbook"' },
        acceptPrivacyPolicyText: { gr: 'Έχω διαβάσει την πολιτική απορρήτου του ΕΒΚ και συμφωνώ με τις διατάξεις περί συλλογής και επεξεργασίας των προσωπικών μου δεδομένων.', en: 'I have read the privacy policy of the GrBC and I agree with its clauses on the collection and use of my personal data.' },
        privacyPolicyLinkText: { gr: 'https://www.grbc.gr/privacy-policy/', en: 'https://www.grbc.gr/en/privacy-policy/' },
        financialLiability2: { gr: 'Οικονομική ευθύνη', en: 'Financial liability' },
        accountingNotes: { gr: 'Σημειώσεις Λογιστηρίου', en: 'Accounting Notes' },
        coursesFirstSemester: { gr: 'Ποια μαθήματα θα παρακολουθήσει στο 1ο εξάμηνο', en: 'Courses to attend in the 1st semester' },
        coursesSecondSemester: { gr: 'Ποια μαθήματα θα παρακολουθήσει στο 2ο εξάμηνο', en: 'Courses to attend in the 2nd semester' },
        coursesAuditor: { gr: 'Ποια μαθήματα θα παρακολουθήσει στο 1ο & 2ο εξάμηνο', en: 'Courses to attend in the 1st & 2nd semester' },
        course1: { gr: 'Μάθημα 1', en: 'Course 1' },
        course2: { gr: 'Μάθημα 2', en: 'Course 2' },
        course3: { gr: 'Μάθημα 3', en: 'Course 3' },
        course4: { gr: 'Μάθημα 4', en: 'Course 4' },
        other: { gr: 'Άλλο', en: 'Other' },
        coursesOther: { gr: 'Άλλο', en: 'Other' },
        auditor: { gr: 'Ακροατής/τρια', en: 'Auditor' },
        ispMinistry: { gr: 'Διεθνές Πρόγραμμα για όσους υπηρετούν σε διακονίες', en: 'ISP ministry' },
        ispEthnicChurch: { gr: 'Διεθνές Πρόγραμμα για τις "Διεθνείς Εκκλησίες"', en: 'ISP ethnic church' },
        ispLanguageTrack: { gr: 'Διεθνές Πρόγραμμα "Νέα Ελληνική Γλώσσα"', en: 'ISP language track' },
        inPersonClasses: { gr: 'Δια ζώσης', en: 'In Person classes' },
        fullTime: { gr: 'Πλήρους Φοίτησης', en: 'Full time' },
        partTimeStudy: { gr: 'Μερικής Φοίτησης', en: 'Part time' },
        residentStudent: { gr: 'Εσωτερικός/-ή', en: 'Resident' },
        nonResidentStudent: { gr: 'Εξωτερικός/-ή', en: 'Non-resident' },
        oneYear: { gr: 'Μονοετές', en: 'One Year' },
        threeYear: { gr: 'Τριετές', en: 'Three Year' },
        residentialStudent: { gr: 'Εσωτερικός/κη', en: 'Residential student' },
        nonResidentialStudent: { gr: 'Εξωτερικός/κη', en: 'Non-residential student' },
        onlineCourses: { gr: 'Διαδικτυακά μαθήματα', en: 'On line courses' },
        generalRegistration: { gr: 'Δεύτερο Στάδιο Εγγραφής', en: 'General Registration' },
        studyMode: { gr: 'Τρόπος Φοίτησης', en: 'Mode of Study' },
        courseEnrollment: { gr: 'Εγγραφή σε Μαθήματα', en: 'Course Enrollment' },
        maritalStatus: { gr: 'Οικογενειακή Κατάσταση', en: 'Marital Status' },
        maritalStatusSame: { gr: 'Ίδια', en: 'Same' },
        maritalStatusChanged: { gr: 'Άλλαξε', en: 'Changed' },
        maritalStatusDetails: { gr: 'Η οικογενειακή κατάσταση άλλαξε ως εξής', en: 'Family status changed as follows' },
        studentType: { gr: 'Επιλέξτε ποιο περιγράφει την κατάστασή σας', en: 'Select which describes your status' },
        studentExternal: { gr: 'Χωρίς Διαμονή', en: 'Without Accommodation' },
        studentInternal: { gr: 'Με Διαμονή', en: 'With Accommodation' },
        fundingSource: { gr: 'Κάλυψη κόστους φοίτησης (και διαμονής)', en: 'Coverage of tuition and fees' },
        fundingSelf: { gr: 'Δικοί μου Πόροι', en: 'Own Resources' },
        fundingThirdParty: { gr: 'Από κάποιον τρίτο', en: 'Third Party' },
        fundingPartial: { gr: 'Διάφορες πηγές', en: 'Various sources' },
        sponsorName: { gr: 'Ονοματεπώνυμο Χορηγού / Υπευθύνου', en: 'Sponsor / Responsible Person Full Name' },
        sponsorPhone: { gr: 'Τηλέφωνο Χορηγού / Υπευθύνου', en: 'Sponsor / Responsible Person Phone' },
        sponsorAmount: { gr: 'Ποσό κάλυψης από Χορηγό (€)', en: 'Amount covered by Sponsor (€)' },
        studentAmount: { gr: 'Υπόλοιπο ποσό κάλυψης από εμένα (€)', en: 'Remaining amount covered by me (€)' },
        churchMissionDetails: { gr: 'Στοιχεία Υπευθύνου (Αν πρόκειται για Εκκλησία ή Ιεραποστολή)', en: 'Responsible Person Details (If Church or Mission)' },
        reasonToContinueQuestion: { gr: 'Γιατί θέλεις να συνεχίσεις τις σπουδές σου στο Ελληνικό Βιβλικό Κολέγιο;', en: 'Why do you want to continue your studies at the Greek Bible College?' },
        ...
        christianCalling: { gr: 'Χριστιανική Κλήση', en: 'Christian Calling' },
        submission: { gr: 'Υποβολή Αίτησης', en: 'Application Submission' },
        postalCode: { gr: 'Τ.Κ.', en: 'Postal Code' }
    };
