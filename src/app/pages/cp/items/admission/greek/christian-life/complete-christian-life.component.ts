...
@Component({
    selector: 'admissions-complete-christian-life',
    templateUrl: './complete-christian-life.component.html'
})
export class CompleteChristianLifeComponent implements OnInit {
