...
export class ISPPersonalComponent implements OnInit {
    userId;
    applicationId = 7;
    ...
    addressInfoOnSubmit() {
        this.formLoading = true;
        if (this.applicationData.application.permanentAddressDifferent === '0') {
            this.applicationData.application.permanentAddress = null;
            this.applicationData.application.permanentCity = null;
            this.applicationData.application.permanentZipCode = null;
            this.applicationData.application.permanentCountry = null;
        }
        this.applicationService.saveUserApplicationData(this.userId, this.applicationId, this.applicationData)
            .then(() => {
                this.modelChanged = false;
    ...
    guardianInfoOnSubmit() {
        this.formLoading = true;
        if (this.applicationData.application.guardianAddressSame === '1') {
            this.applicationData.application.guardianAddress = null;
            this.applicationData.application.guardianCity = null;
